...
from intric.authentication.signed_urls import (
...
from intric.files.file_models import ContentDisposition, FileBaseWithContent, FileType
from intric.files.file_service import FileService
from intric.files.object_storage import FileObjectStorage, ObjectStorageError
...
class TestFileServiceStorageOffload:
    ...
    async def test_stream_untouched_when_storage_unconfigured(self):
        ...
        protocol.to_domain.assert_awaited_once_with(upload)
        assert saved.storage_key is None
