...
_TABLE_MODULES = (
    ...
    "intric.database.tables.flow_classification_retention_policy_table",
    ...
    "intric.database.tables.governance_policy_table",
    "intric.database.tables.mcp_server_table",
    "intric.database.tables.mcp_tool_references_table",
