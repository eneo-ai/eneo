...
from intric.main.config import get_loglevel, get_settings

# Celery task registration is per app instance; `src.intric...` creates
# a second app with no Flow tasks registered.
FLOW_CELERY_APP = "intric.flows.runtime.celery_app:celery_app"
