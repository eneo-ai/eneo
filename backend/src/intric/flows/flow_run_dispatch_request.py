...
def build_flow_run_dispatch_request(
    ...
    if principal.principal_type == PrincipalType.SERVICE_KEY:
        if principal.principal_api_key_id is None:
            raise ValueError("principal_api_key_id required for service-key dispatch")
    ...
    match request:
        ...
        case FlowRunServiceKeyDispatchRequest():
            return {
                ...
                "principal_api_key_id": str(request.principal_api_key_id),
            }
        case _:
