...
class InfoBlobRepository:
    ...
    async def update(self, info_blob: InfoBlobUpdate) -> InfoBlobInDB | None:
    ...
    async def get(self, id: UUID) -> InfoBlobInDB | None:
    ...
    async def delete(self, id: int) -> InfoBlobInDB | None:
