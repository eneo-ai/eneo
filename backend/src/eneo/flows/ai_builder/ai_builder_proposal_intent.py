...
def build_create_flow_tool_schema(
    *,
    ...
    if confirmed_runtime_inputs and not is_pure_audio_transcription:
        # A contract identity is stated where it is enforced as well as in the
        # brief: the model writes output_fields against this description, and
        # without it the measured cohort repeated runtime-input identities as
        # output fields (confirmed_runtime_input_source_output_collision).
