...
def _disclosure_content(
    ...
    *,
    ...
    return RequirementsDisclosureContent(
        ...
        run_preview=_run_preview(session_state, locale),
...
def _run_preview(
    ...
    return RunPreviewPayload(
        ...
        runtime_input_label=(
            _slot_value_for_slot("primary_runtime_input", runtime_input, locale)
            if runtime_input
            else None
        ),
        ...
        result_type_label=(
            _slot_value_for_slot("terminal_output", result_type, locale)
            if result_type
            else None
        ),
