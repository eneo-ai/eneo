...
from eneo.flows.api.flow_models import FlowRunReviewCheckpointPublic
from eneo.flows.domain.flow import FlowRunReviewCheckpoint


@dataclass(frozen=True, slots=True)
class FlowServicePrincipalActorPresenter:
...
async def _load_flow_service_principal_actor_summaries(
    *,
    api_key_repo: ApiKeysV2Repository,
    tenant_id: UUID,
