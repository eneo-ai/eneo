...
class FlowRunPublic(FlowRunSummaryPublic):
    ...
    speaker_labels: bool | None = Field(
        ...
        description=(
            ...
            "the flow's default at that time. Null when the run recorded no "
            "setting: the flow offers no speaker-label option, or the run "
            "predates recording it; a new run then follows the flow's current "
            "default. When true or false, a new run keeps the setting by sending "
