...
class UserService:
    ...
    async def _resolve_space_id_for_scope(
        ...
        from eneo.database.tables.app_table import Apps  # noqa: F811
        from eneo.database.tables.assistant_table import Assistants  # noqa: F811
    ...
    async def _build_service_user(self, key: ApiKeyV2InDB) -> "UserInDB":
        ...
        from eneo.users.user import UserInDB as UserInDBModel
