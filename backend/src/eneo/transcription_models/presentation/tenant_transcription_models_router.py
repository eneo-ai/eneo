...
from eneo.transcription_models.presentation.transcription_model_models import TranscriptionModelPublic
...
async def create_tenant_transcription_model(
    ...
    from eneo.transcription_models.domain.transcription_model_repo import TranscriptionModelRepository
