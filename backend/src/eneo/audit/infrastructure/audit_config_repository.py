...
from eneo.audit.domain.repositories.audit_config_repository import AuditConfigRepository
from eneo.database.tables.audit_category_config_table import AuditCategoryConfig
