...
class AIModel(Entity):
    ...
    def litellm_deprecation_date(self) -> Optional[str]:
        from eneo.ai_models.deprecation_lookup import get_litellm_deprecation_date
    ...
    def is_effectively_deprecated(self) -> bool:
        from eneo.ai_models.deprecation_lookup import is_model_effectively_deprecated
