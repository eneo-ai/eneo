...
PERMISSIONS_WITH_DESCRIPTION = {
    ...
    Permission.WIDGETS: "Configure embeddable widgets for assistants in spaces you can edit. Activating a widget for the public additionally requires the admin permission.",
