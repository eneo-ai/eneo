...
if TYPE_CHECKING:
    ...
    from eneo.templates.app_template.api.app_template_models import AppTemplateCreate
    ...
    from eneo.templates.app_template.api.app_template_models import AppTemplateUpdate
    ...
    async def rollback_template(
        ...
        stmt = (
            ...
            .values(
                ...
                completion_model_id=UUIDType(completion_model_id) if completion_model_id else None,
