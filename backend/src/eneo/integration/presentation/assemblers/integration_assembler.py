...
from eneo.integration.presentation.models import Integration as IntegrationModel
from eneo.integration.presentation.models import IntegrationList, IntegrationType
