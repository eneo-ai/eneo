...
from eneo.integration.presentation.models import TenantIntegration as TenantIntegrationModel
from eneo.integration.presentation.models import TenantIntegrationList
