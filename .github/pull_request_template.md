...
- [ ] Checked by hand (ACCESSIBILITY.md → Manual test protocol): keyboard only, screen reader (VoiceOver or NVDA), 200%/400% zoom and a 320 px wide window, text spacing, reduced motion, forced colours, light and dark mode
