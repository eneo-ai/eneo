...
echo "Set COMPOSE_PROFILES=object-content in .devcontainer/.env, then reopen the devcontainer."
echo ""
echo -e "${BLUE}Open your browser and go to ${BOLD}http://localhost:${ENEO_WEB_PORT:-3000}${NC}"
