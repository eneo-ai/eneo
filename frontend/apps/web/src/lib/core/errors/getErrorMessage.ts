 ...
 *    - messages/en.json → "intric_error_{code}": "English message"
 *    - messages/sv.json → "intric_error_{code}": "Swedish message"
 *
...
const ERROR_CODE_MESSAGES: Record<number, () => string> = {
	...
	9001: () => m.intric_error_9001(), // UNAUTHORIZED
	9005: () => m.intric_error_9005(), // AUTHENTICATION_ERROR
	9019: () => m.intric_error_9019(), // USER_INACTIVE
	9025: () => m.intric_error_9025(), // TENANT_SUSPENDED

	// --- Model & provider issues ---
	9002: () => m.intric_error_9002(), // UNSUPPORTED_MODEL
	9020: () => m.intric_error_9020(), // NO_MODEL_SELECTED
	9026: () => m.intric_error_9026(), // API_KEY_NOT_CONFIGURED
	9031: () => m.intric_error_9031(), // PROVIDER_INACTIVE
	9033: () => m.intric_error_9033(), // MODEL_NOT_AVAILABLE
	9034: () => m.intric_error_9034(), // KNOWLEDGE_MODEL_UNAVAILABLE
	9035: () => m.intric_error_9035(), // SECURITY_CLASSIFICATION_MISMATCH

	// --- AI service errors ---
	9008: () => m.intric_error_9008(), // QUOTA_EXCEEDED
	9010: () => m.intric_error_9010(), // OPENAI_ERROR
	9011: () => m.intric_error_9011(), // CLAUDE_ERROR

	// --- Internal errors ---
	9024: () => m.intric_error_9024() // INTERNAL_SERVER_ERROR
};
