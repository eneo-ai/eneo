...
<section
  class="flex min-h-0 flex-1 items-start justify-center overflow-y-auto px-6 py-12 max-[480px]:px-4 max-[480px]:py-6"
>
  <div class="flex w-full max-w-[40rem] flex-col gap-6">
    <div class="flex flex-col gap-1">
      <h2 class="text-primary text-xl leading-tight font-semibold -tracking-[0.01em]">
