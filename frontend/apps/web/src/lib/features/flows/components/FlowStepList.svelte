...
<div class="flex h-full flex-col">
  ...
  {#if !isPublished && steps.length > 0}
    <div class="px-3 pt-2 pb-3">
      ...
      <button
        type="button"
        class="border-default text-secondary hover:border-accent-default hover:bg-accent-dimmer/60 hover:text-accent-default focus-visible:ring-ring flex min-h-[40px] w-full items-center justify-center gap-2 rounded-xl border border-dashed py-2.5 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none"
