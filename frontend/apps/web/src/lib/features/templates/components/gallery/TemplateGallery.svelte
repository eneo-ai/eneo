...
<Dialog.Root bind:open={$showTemplateGallery}>
  <Dialog.Content class={dialogLayout.content("large")} closeLabel={m.close()}>
    <div class={dialogLayout.body}>
      <div class={[dialogLayout.section, "mt-2"]}>
        <!-- Dialog Header -->
        <div class="flex items-center justify-between px-8 pt-8 pb-6">
          <div class="flex w-full flex-col">
            <Dialog.Title class="px-4 pb-1 text-2xl font-bold">{m.select_a_template()}</Dialog.Title
            >
            <Dialog.Description class="text-secondary max-w-[50ch] px-4 text-base">
                ...
                >
                  ...
                  >
                    ...
                    <div class="flex w-full items-center gap-2.5">
                      ...
                      <h4
                        class="text-dynamic-stronger line-clamp-1 text-left text-sm font-semibold"
                      >
