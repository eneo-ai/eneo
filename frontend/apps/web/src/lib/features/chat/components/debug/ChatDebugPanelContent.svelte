...
<div class="border-border @container flex flex-col gap-2 border-b px-5 py-4">
...
<div class="@container min-h-0 flex-1 [scrollbar-gutter:stable] overflow-y-auto overscroll-contain">
