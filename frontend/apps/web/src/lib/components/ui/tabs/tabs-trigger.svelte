...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		"data-active:bg-background data-active:border-border data-active:shadow-sm dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 data-active:text-foreground data-active:font-semibold",
