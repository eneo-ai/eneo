...
<TabsPrimitive.Trigger
  ...
  class={cn(
    ...
    "data-[state=active]:bg-background data-[state=active]:text-foreground dark:data-[state=active]:text-foreground dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30",
    // The fill alone is too faint against the list; the border reaches 3:1 in both themes.
    "group-data-[variant=default]/tabs-list:data-[state=active]:border-muted-foreground",
