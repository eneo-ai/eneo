<script lang="ts" module>
  ...
  export const badgeVariants = tv({
    ...
    variants: {
      variant: {
        // bg-primary / text-primary-foreground are shadowed by eneo's
        // page-background / body-text tokens (see app.css "primary"
        // namespace conflict). Use accent tokens directly so the badge
