...
<CheckboxPrimitive.Root
  ...
  class={cn(
    ...
    "border-input dark:bg-input/30 data-[state=checked]:bg-accent-default data-[state=checked]:text-on-fill dark:data-[state=checked]:bg-accent-default data-[state=checked]:border-accent-default aria-invalid:aria-checked:border-accent-default aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 peer relative flex size-4 shrink-0 items-center justify-center rounded-[4px] border transition-colors outline-none group-has-disabled/field:opacity-50 after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:ring-3 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:ring-3",
    className
  )}
  bind:checked
  bind:indeterminate
