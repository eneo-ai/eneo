    ...
    {#if iconUrl}
      <div class="relative flex h-32 w-32 items-center justify-center overflow-hidden rounded-xl">
        ...
        {#if item.type === "group-chat"}
          <div
            class="absolute -right-1 -bottom-1 flex h-8 w-8 items-center justify-center rounded-full border border-current bg-white/80 text-inherit backdrop-blur-sm dark:bg-black/60"
          >
            <svg
