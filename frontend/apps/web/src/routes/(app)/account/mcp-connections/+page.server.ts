 ...
 *
 * The read-out comes from /api/v1/me/mcp-connections. The fetch is
 * direct against the configured backend with the session bearer.
 */
...
type ConnectionStatus =
  "connected" | "expired" | "not_authenticated" | "idp_mismatch" | "not_applicable";
