...
<script lang="ts">
  ...
  const modelSuggestions: Record<string, Record<string, Array<{ name: string; displayName: string; tokenLimit?: number; vision?: boolean; reasoning?: boolean; supportsToolCalling?: boolean }>>> = {
    openai: {
      completion: [
        { name: "gpt-5.2", displayName: "GPT-5.2", tokenLimit: 200000, vision: true, supportsToolCalling: true },
        { name: "gpt-5.1", displayName: "GPT-5.1", tokenLimit: 200000, vision: true, reasoning: true, supportsToolCalling: true },
        { name: "gpt-5-mini", displayName: "GPT-5 Mini", tokenLimit: 128000, vision: true, supportsToolCalling: true },
        { name: "gpt-4o", displayName: "GPT-4o", tokenLimit: 128000, vision: true, supportsToolCalling: true },
        { name: "gpt-4o-mini", displayName: "GPT-4o Mini", tokenLimit: 128000, vision: true, supportsToolCalling: true }
      ],
      embedding: [
    ...
    anthropic: {
      completion: [
        { name: "claude-opus-4-5-20251101", displayName: "Claude Opus 4.5", tokenLimit: 200000, vision: true, reasoning: true, supportsToolCalling: true },
        { name: "claude-sonnet-4-20250514", displayName: "Claude Sonnet 4", tokenLimit: 200000, vision: true, supportsToolCalling: true },
        { name: "claude-3-7-sonnet-20250219", displayName: "Claude 3.7 Sonnet", tokenLimit: 200000, vision: true, reasoning: true, supportsToolCalling: true },
        { name: "claude-3-5-sonnet-20241022", displayName: "Claude 3.5 Sonnet", tokenLimit: 200000, vision: true, supportsToolCalling: true },
        { name: "claude-3-5-haiku-20241022", displayName: "Claude 3.5 Haiku", tokenLimit: 200000, vision: true, supportsToolCalling: true }
      ],
      embedding: [],
      transcription: []
    },
    gemini: {
      completion: [
        { name: "gemini-2.5-pro", displayName: "Gemini 2.5 Pro", tokenLimit: 1048576, vision: true, reasoning: true, supportsToolCalling: true },
        { name: "gemini-2.5-flash", displayName: "Gemini 2.5 Flash", tokenLimit: 1048576, vision: true, reasoning: true, supportsToolCalling: true },
        { name: "gemini-2.0-flash", displayName: "Gemini 2.0 Flash", tokenLimit: 1048576, vision: true, supportsToolCalling: true },
        { name: "gemini-1.5-pro", displayName: "Gemini 1.5 Pro", tokenLimit: 2097152, vision: true, supportsToolCalling: true },
        { name: "gemini-1.5-flash", displayName: "Gemini 1.5 Flash", tokenLimit: 1048576, vision: true, supportsToolCalling: true }
      ],
      embedding: [
    ...
    cohere: {
      completion: [
        { name: "command-r-plus", displayName: "Command R+", tokenLimit: 128000, supportsToolCalling: true },
        { name: "command-r", displayName: "Command R", tokenLimit: 128000, supportsToolCalling: true }
      ],
      embedding: [
    ...
    mistral: {
      completion: [
        { name: "mistral-large-latest", displayName: "Mistral Large", tokenLimit: 128000, supportsToolCalling: true },
        { name: "mistral-medium-latest", displayName: "Mistral Medium", tokenLimit: 32000, supportsToolCalling: true },
        { name: "mistral-small-latest", displayName: "Mistral Small", tokenLimit: 32000, supportsToolCalling: true }
      ],
      embedding: [
