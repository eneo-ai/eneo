...
export function getPermissionCopy(name: string, fallbackDescription: string): Entry {
  ...
  switch (name) {
    ...
    case "skills_management":
      return {
        label: m.permission_skills_management(),
        description: m.permission_skills_management_description()
      };
    case "personal_chat":
      return {
        label: m.permission_personal_chat(),
        description: m.permission_personal_chat_description()
      };
    case "group_chats":
      return {
    ...
    case "flows_view":
      return {
        label: m.permission_flows_view(),
        description: m.permission_flows_view_description()
      };
    case "flows_run":
      return {
        label: m.permission_flows_run(),
        description: m.permission_flows_run_description()
      };
    case "flows_manage":
      return {
    ...
    case "flows_ai_builder_review":
      return {
        label: m.permission_flows_ai_builder_review(),
        description: m.permission_flows_ai_builder_review_description()
      };
    case "flows_trace":
      return {
    ...
    case "web_search":
      return {
        ...
        description: m.permission_web_search_description()
      };
