<script lang="ts">
  ...
  function getActionLabel(action: ActionType | "all"): string {
    const labels: Partial<Record<ActionType | "all", () => string>> = {
      ...
      api_key_created: m.audit_action_api_key_created,
      api_key_updated: m.audit_action_api_key_updated,
      api_key_revoked: m.audit_action_api_key_revoked,
      api_key_suspended: m.audit_action_api_key_suspended,
      api_key_reactivated: m.audit_action_api_key_reactivated,
      api_key_rotated: m.audit_action_api_key_rotated,
      api_key_expired: m.audit_action_api_key_expired,
      api_key_used: m.audit_action_api_key_used,
      api_key_auth_failed: m.audit_action_api_key_auth_failed,
      api_key_expiration_extended: m.audit_action_api_key_expiration_extended,
      api_key_purged: m.audit_action_api_key_purged,
