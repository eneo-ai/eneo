...
// The whole document, including <html lang>, depends on the language in the
// URL, so no root layout exists and the site-wide 404 (global-not-found)
// renders this shell itself.
