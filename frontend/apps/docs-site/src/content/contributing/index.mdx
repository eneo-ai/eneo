...
Pull requests run CI, Dependency Review, and CodeQL before merge. These checks make dependency updates reviewable and prevent known high-severity vulnerable dependencies from entering `develop`.

See [Security for Contributors](/contributing/security) for the required checks, alert triage order, and how to handle dependency or code scanning failures.
