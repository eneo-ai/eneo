...
variant in bounded, resumable PostgreSQL-inline transactions. The later contract
applies the fail-closed completion and live-reference recheck described in
