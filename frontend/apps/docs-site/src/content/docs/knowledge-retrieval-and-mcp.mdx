...
| --- | --- | --- |
| `specific` | Fetch a small candidate set, apply an autocut, and keep a high-precision result set. | "When does the recycling center open?" |
...
- a search call cannot return more than 20 chunks;
- specific search normally returns at most 6 chunks;
