...
`flows = read` covers the read half of that journey: published flows, runtime paths, run contracts, own run status, and active review checkpoints. Authoring—draft create, update, delete, publish, and template management—stays with user principals.
