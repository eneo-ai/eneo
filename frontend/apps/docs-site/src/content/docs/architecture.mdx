...
<div className="bg-white dark:bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 my-8">
  <img
    ...
    alt="Eneo System Architecture showing Client, Reverse Proxy, Eneo Platform (Compute and Data layers), and AI Models (External and Self-hosted)"
...
Eneo's frontend consists of multiple applications, each using the framework best suited for its purpose.

#### Main Web Application (SvelteKit)

The primary user-facing application is built with SvelteKit.
...
The documentation site uses Next.js with Nextra for optimized static documentation generation.

**Technology Stack:**
- **Framework**: Next.js 15 with React 19
- **Documentation Framework**: Nextra 4.x with nextra-theme-docs
- **Styling**: Tailwind CSS
...
<div className="bg-white dark:bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 my-8">
  <img
    src="/diagrams/document-processing-pipeline.svg"
...
### Why SvelteKit for the Main Application?
...
### Why Next.js + Nextra for Documentation?
