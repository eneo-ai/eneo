...
This page is maintained alongside the SQLAlchemy models and Flow JSONB ownership registry. Update it after a schema or JSONB ownership change. Model classes live in `backend/src/eneo/database/tables/` and are named after their tables (`flow_runs` is `FlowRuns`).
...
| [Deferred adjacent tables](#deferred-adjacent-tables)                               | Flow package imports reference Flow tables but are not part of the run or history model.                                                                                                             | `flow_package_imports`                                                                                                                                                                                                                                               |
...
Flow package imports reference Flow tables but are not part of the run or history model.
