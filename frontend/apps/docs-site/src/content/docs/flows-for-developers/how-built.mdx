...
| -------------------------------------------------------- | ----------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| `Flows engine must not import AI Builder`                | `forbidden` | 79 Flow engine root entries           | `eneo.flows.ai_builder`                                                                                                              | `eneo.flows.api.flow_router -> eneo.flows.ai_builder.ai_builder_router` |
...
| `AI Builder must not import MCP execution surfaces`      | `forbidden` | `eneo.flows.ai_builder`               | `eneo.mcp_servers.infrastructure.proxy`, `eneo.mcp_servers.infrastructure.client`, `eneo.mcp_servers.application.mcp_server_service` | none                                                                    |
