...
| -------------------------------------------------------- | ----------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| `Flows engine must not import AI Builder`                | `forbidden` | 80 Flow engine root entries           | `eneo.flows.ai_builder`                                                                                                              | `eneo.flows.api.flow_router -> eneo.flows.ai_builder.ai_builder_router` |
