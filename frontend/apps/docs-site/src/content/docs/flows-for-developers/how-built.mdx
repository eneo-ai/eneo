...
| -------------------------------------------------------- | ----------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| `Flows engine must not import AI Builder`                | `forbidden` | 79 Flow engine root entries             | `intric.flows.ai_builder`                                                                                                                  | `intric.flows.api.flow_router -> intric.flows.ai_builder.ai_builder_router` |
| `FCM must not import AI Builder`                         | `forbidden` | `intric.flows.flow_capability_manifest` | `intric.flows.ai_builder`                                                                                                                  | none                                                                        |
| `Flow package application must not import AI Builder`    | `forbidden` | `intric.flow_packages.application`      | `intric.flows.ai_builder`                                                                                                                  | none                                                                        |
| `Flow package domain must not import AI Builder`         | `forbidden` | `intric.flow_packages.domain`           | `intric.flows.ai_builder`                                                                                                                  | none                                                                        |
| `Flow package domain must not import infrastructure`     | `forbidden` | `intric.flow_packages.domain`           | `intric.flow_packages.infrastructure`                                                                                                      | none                                                                        |
| `Flow package infrastructure must not import AI Builder` | `forbidden` | `intric.flow_packages.infrastructure`   | `intric.flows.ai_builder`                                                                                                                  | none                                                                        |
| `AI Builder must not import MCP execution surfaces`      | `forbidden` | `intric.flows.ai_builder`               | `intric.mcp_servers.infrastructure.proxy`, `intric.mcp_servers.infrastructure.client`, `intric.mcp_servers.application.mcp_server_service` | none                                                                        |
...
| `flow_run_contract_models` | `module` | Run contract models are public API-facing schemas. |
...
<details>
<summary><code>domain</code> (46 entries)</summary>
...
| `flow_care_data_policy`             | `module` | Care data policy is a domain policy.                                |
...
<details>
<summary><code>remove-merge-later</code> (1 entries)</summary>

| Entry          | Kind     | Owns / start here                                                             |
| -------------- | -------- | ----------------------------------------------------------------------------- |
| `flow_factory` | `module` | Pass-through ORM/domain mapping should be deleted or folded into persistence. |
...
| `backend/src/intric/flows/application/flow_run_access_policy.py` | Runtime access text names the canonical tenant and principal enforcement owner.                        |
