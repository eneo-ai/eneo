...
**Source refs.** Step input rows: `backend/src/eneo/database/tables/flow_tables.py`, Rerun operation rows: `backend/src/eneo/database/tables/flow_tables.py`, Rerun accept path: `backend/src/eneo/flows/application/flow_run_rerun_service.py`.
...
**Source refs.** Review checkpoint exceptions: `backend/src/eneo/flows/domain/review_checkpoint_exceptions.py`, Rerun service translation: `backend/src/eneo/flows/application/flow_run_rerun_service.py`.
...
**Source refs.** Flow principal: `backend/src/eneo/flows/principal.py`, Runtime actor: `backend/src/eneo/flows/runtime/flow_run_actor.py`, Run access policy: `backend/src/eneo/flows/application/flow_run_access_policy.py`.
...
**Source refs.** HTTP validator: `backend/src/eneo/flows/flow_validators_http.py`, HTTP transport package: `backend/src/eneo/flows/http_transport/__init__.py`, HTTP runtime: `backend/src/eneo/flows/runtime/http_runtime.py`.
...
**Source refs.** Checkpoint repository: `backend/src/eneo/flows/infrastructure/flow_run_review_checkpoint_repo.py`, Checkpoint service: `backend/src/eneo/flows/application/flow_run_review_checkpoint_service.py`.
...
**Source refs.** JSONB owner registry: `backend/src/eneo/flows/infrastructure/flow_jsonb_ownership.py`, Schema docs exporter: `backend/src/eneo/flows/infrastructure/flow_schema_docs_exporter.py`, Data schema docs: `frontend/apps/docs-site/src/content/docs/flows-for-developers/data-schema.mdx`.
...
**Source refs.** Error-code enum: `backend/src/eneo/flows/flow_api_error_code.py`, Failure taxonomy: `backend/src/eneo/flows/flow_error_taxonomy.py`, Developer failure page: `frontend/apps/docs-site/src/content/docs/flows-for-developers/when-things-fail.mdx`.
...
### 9. AI Builder create plans assemble before lowering
...
**Source refs.** Assembly plan: `backend/src/eneo/flows/ai_builder/ai_builder_assembly/plan.py`, Topology admission: `backend/src/eneo/flows/ai_builder/ai_builder_assembly/create.py`, Fixed planned steps: `backend/src/eneo/flows/ai_builder/ai_builder_assembly/fixed_steps.py`, Plan lowering: `backend/src/eneo/flows/ai_builder/ai_builder_assembly/lower.py`, Capability manifest: `backend/src/eneo/flows/flow_capability_manifest.py`, Step chain rules: `backend/src/eneo/flows/step_chain_rules.py`.

### 10. Review checkpoint as a revisioned state machine
...
**Source refs.** Checkpoint states: `backend/src/eneo/flows/enums.py`, Checkpoint table: `backend/src/eneo/database/tables/flow_tables.py`, Lifecycle docs: `frontend/apps/docs-site/src/content/docs/flows-for-developers/run-lifecycle.mdx`.

### 11. Rerun lineage and invalidation ownership
...
**Source refs.** Rerun service: `backend/src/eneo/flows/application/flow_run_rerun_service.py`, Rerun repository: `backend/src/eneo/flows/infrastructure/flow_run_rerun_repo.py`, Rerun graph: `backend/src/eneo/flows/flow_run_rerun_graph.py`.
