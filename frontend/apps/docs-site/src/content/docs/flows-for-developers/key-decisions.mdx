...
**Source refs.** JSONB owner registry: `backend/src/eneo/flows/infrastructure/flow_jsonb_ownership.py`, Data schema docs: `frontend/apps/docs-site/src/content/docs/flows-for-developers/data-schema.mdx`.
