...
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| API router or response schema        | Start in `api/`, then follow the application service it delegates to.                                                              | Prove OpenAPI shape, FlowApiErrorCode mapping, and docs parity.                                       | Run execution router: `backend/src/eneo/flows/api/flow_run_execution_router.py`, API design standard: `docs/engineering/api-design-standard.md`                                                                                                                                                                                                            |
...
| ---- | -------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Start from `FlowRunPublic` in the API response or evidence export.                                       | `FlowRunPublic.id`, `FlowRunPublic.status`, `FlowRunPublic.trace_id`, `FlowRunPublic.revision`                                                                                                                                                       | Use `trace_id` as the persisted Flow correlation token, not as the OpenTelemetry protocol trace id.                     | Run API model: `backend/src/eneo/flows/api/flow_models.py`, Evidence export: `backend/src/eneo/flows/flow_run_export_json.py`                                                                                                                                                                                                                                        |
