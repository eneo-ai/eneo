...
| Step handler or output mode          | Start runtime handler construction at `FlowRunExecutor._build_step_handler` and keep concrete behavior in `runtime/step_handlers/` | Prove parser validation, handler or output-processing behavior, and typed errors.                     | Handler construction: `backend/src/intric/flows/runtime/executor.py`, Handler contract: `backend/src/intric/flows/runtime/step_handlers/base.py`, Output modes: `backend/src/intric/flows/output_modes.py`, Output processing: `backend/src/intric/flows/output_processing.py`, Step definition parser: `backend/src/intric/flows/runtime/step_definition_parser.py` |
