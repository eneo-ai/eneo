...
review can pause a run, and a new run repeats completed work when needed.
...
| `application`    | Use cases and request-independent orchestration                       | A flow, run, review, evidence, or retention operation changes        |
...
| Review run lifecycle behavior          | [The run lifecycle](/docs/flows-for-developers/run-lifecycle)                                         | Which service owns each state transition and recovery path         |
