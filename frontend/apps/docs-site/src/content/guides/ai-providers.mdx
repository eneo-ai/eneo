...
<div className="bg-white dark:bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 my-8">
  <img
    ...
    alt="LiteLLM Architecture Overview showing how Eneo routes AI requests through the unified LiteLLM abstraction layer to various providers"
...
The provider registry detects custom providers based on the `litellm_model_name` prefix and applies the appropriate configuration.

<div className="bg-white dark:bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 my-8">
  <img
    src="/diagrams/litellm-routing.svg"
    alt="LiteLLM Provider Routing showing how model name prefixes are detected and routed to the appropriate provider"
    className="w-full max-w-4xl mx-auto"
  />
</div>
