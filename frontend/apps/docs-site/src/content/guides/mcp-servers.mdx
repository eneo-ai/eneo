...
## MCP boundary for Flows

MCP remains available to standalone assistants and conversations. Flows do not
support MCP servers or tools at authoring, publish, runtime, or package
boundaries.
