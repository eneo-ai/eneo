...
object-store path, not vendor-specific storage modes.
...
| Large file uploads fail              | Admin policy or inline operator ceiling is lower   | Review configured, effective, and source values in Admin > Storage                  |
