...
<Tabs items={['Access justification', 'Logs & filters', 'Configuration', 'Log details']}>
  <Tabs.Tab>
    ![Access justification modal](/images/audit/access-justification.png)

    ![Access reason selection](/images/audit/access-reason-list.png)
  </Tabs.Tab>
  <Tabs.Tab>
    ![Audit logs view](/images/audit/logs-view.png)

    ![User search filter](/images/audit/user-filter.png)

    ![Action multi-select filter](/images/audit/action-filter.png)
  </Tabs.Tab>
  <Tabs.Tab>
    ![Audit configuration overview](/images/audit/config-overview.png)

    ![Audit configuration details](/images/audit/config-details.png)
  </Tabs.Tab>
  <Tabs.Tab>
    ![Audit log details panel](/images/audit/log-details.png)
  </Tabs.Tab>
</Tabs>
