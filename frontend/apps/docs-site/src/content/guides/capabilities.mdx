...
- Switching models after a conversation has messages shows a warning and
  offers a new conversation. The new model may fit less history or support
  ...
  model. The model that produced each answer remains recorded with that message.
