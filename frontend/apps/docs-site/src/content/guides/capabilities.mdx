...
- Switching models after a conversation has messages asks for confirmation and
  offers a new conversation as an option. The new model may fit less history or support
  different tools and images. Messages remain stored; the backend prepares
