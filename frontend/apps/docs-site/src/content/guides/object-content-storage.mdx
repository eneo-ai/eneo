...
destination, complete the copy, and switch again. If files have already been
stored in object storage since the switch, Eneo refuses the one-click switch
back; copy the current bucket back first and use **Change destination**.
