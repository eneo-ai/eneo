...
Both use short-lived signed access. Original recovery is strict: Eneo never
substitutes a processed representation when the original is absent. Instead it
returns `404 file_original_not_found` (Eneo error `9045`).
