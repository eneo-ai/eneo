...
| Upgrade to 2.2.0 (renamed variables)     | [Upgrading to 2.2.0](/guides/upgrade-2-2-0)                            |
...
### [Upgrading to 2.2.0](/guides/upgrade-2-2-0)

Rename the deployment settings that 2.2 no longer reads:

- Environment variables to rename, and the ones removed without a replacement
- What the backend and web app log or refuse at startup
- API names that changed for integrations
