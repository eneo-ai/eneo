...
| ---------------------------------------- | ---------------------------------------------------------------------- |
| Put an Assistant on a public website     | [Embed an Assistant](/guides/embed-widget)                             |
...
| Oversee the organisation's spaces        | [Space Oversight](/guides/space-oversight)                             |
...
### [Space Oversight](/guides/space-oversight)

Oversee every shared space in the organisation as an administrator:

- See each space's settings, members, resources and usage without being a member
- Manage members and fix spaces that have no administrator
- Join a space with a recorded reason when you need its content
- Understand what the audit log always records and what stays private
...
### [Embed an Assistant on Your Website](/guides/embed-widget)

Publish an assistant as a chat widget on the organisation's public website:

- Configure, preview and activate a widget, then install its snippet
- Understand what anonymous visitors can reach and what they never get
- Set the tenant policy and house-style templates as an administrator
- Operator settings, retention, security properties and a DPIA checklist
