...
<div className="bg-white dark:bg-white p-4 rounded-lg border border-gray-200 dark:border-gray-700 my-8">
  <img
    src="/diagrams/sharepoint-integration.svg"
...
Which permissions are needed depends on which authentication method you choose (see next section), but generally you need:
...
After adding the permissions, click **Grant admin consent** to approve them at the organization level.
