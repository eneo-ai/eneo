...
The Assistant builder exposes this choice for each attached Skill. Apps and
Personal Chat remain eager: their attached Skills enter every request in the
configured order. Runtime evidence, rather than the adoption view, shows which
Assistant Skills were eligible, requested, blocked, or included.
