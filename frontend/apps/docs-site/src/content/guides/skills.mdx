...
| Blocker                             | What happened                                                                                                                                                                 | How to clear it                                                                |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Slug already taken                  | Another Skill in the same Space, or in the organisation catalogue, already uses that slug                                                                                     | Choose a different slug                                                        |
...
| Execution block changed             | The block you reviewed was released or replaced before your action reached the server                                                                                         | The page reloads the live block state; review it and try again                 |
