...
| Skill is still attached             | The Skill is attached to an Assistant, an App, or the organisation Personal Chat policy                                                                                       | Remove every attachment, then remove the Skill                       |
...
First detach it from every Assistant, App, and Personal Chat policy, and wait
for queued or running App jobs to finish. Organisation Skills retain their
instructions, immutable versions, and audit history under **Removed**, including
Skills that were published before removal. Local Space Skills still use permanent
deletion once their bindings and active App jobs have been cleared.
