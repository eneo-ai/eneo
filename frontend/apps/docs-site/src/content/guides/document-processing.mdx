...
In the upload area, expand **File types and sizes** to see the formats and
per-file limits available for that upload. The list starts collapsed and opens
automatically if you select or drop a file whose type is not supported.
