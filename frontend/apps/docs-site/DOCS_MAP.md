...
| `backend/src/eneo/modules/**`, `server/dependencies/module_credentials.py`, `with_module_user` in `server/dependencies/container.py`, `frontend/apps/web/src/routes/(public)/module-login/**` | `docs/module-authentication.mdx`                                                   |
...
| Code                                                                                                                                                                                                                                                                          | Pages                                                                                                   |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| `backend/src/eneo/flows/**` (runtime, validators, public API models), `backend/src/eneo/flow_packages/**`                                                                                                                                                                     | `docs/flows.mdx`, `docs/flows-for-developers/**`                                                        |
| `backend/src/eneo/flows/api/**` (runtime routes, run contract, request models), `flows/flow_api_error_code.py`, `flows/flow_error_taxonomy.py`                                                                                                                                | `guides/flows/integrating-flows.mdx`, `guides/flows-api-guide.mdx`, `guides/flows/reference/errors.mdx` |
