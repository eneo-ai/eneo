...
/**
 * Test-only: what jsdom lacks and Astryx uses — layout observers, media
 * queries, CSS.escape, scroll locking and modal <dialog>. Call in beforeAll.
 */
export function installAstryxDomStubs() {
