...
export const eneoIcons = () => {
  ...
  return {
    ...
    async load(id) {
      ...
      // First load will go to @eneo/icons/app -> we export {default as IconApp} from @eneo/icons/app.svelte
      ...
      // Second load will go to @eneo/icons/app.svelte -> now we actual export the Icon component
