...
export function createClient(args) {
  ...
  const version = "DEV-20260918T122627Z"; // # Client version auto-updates when running the updater, do not edit this line.
  ...
  return {
    fetch: async (endpoint, { method, params, requestBody, signal, headers }) => {
      ...
      try {
        ...
        EneoError.throw(error, { endpoint: requestEndpoint });
        throw error;
      }
    },
