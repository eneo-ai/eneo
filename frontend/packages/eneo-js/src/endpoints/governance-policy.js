...
export function initGovernancePolicy(client) {
  return {
     ...
     * reasoning_policy / file_policy / skills) are touched.
     * @param {Object} params
     ...
     * @param {{default_effort: string | null, allow_user_override: boolean} | null} [params.reasoning_policy]
     * @param {{inline_file_text: boolean} | null} [params.file_policy]
    ...
    update: async ({
      ...
      if (reasoning_policy !== undefined) body.reasoning_policy = reasoning_policy;
      if (file_policy !== undefined) body.file_policy = file_policy;
